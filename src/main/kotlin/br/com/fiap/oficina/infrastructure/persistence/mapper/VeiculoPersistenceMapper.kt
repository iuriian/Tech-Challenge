...
@Component
class VeiculoPersistenceMapper(private val clienteMapper: ClientePersistenceMapper) {
    fun toDomain(entity: VeiculoJpaEntity): Veiculo = Veiculo(
    ...
    fun toJpa(domain: Veiculo): VeiculoJpaEntity = VeiculoJpaEntity(
