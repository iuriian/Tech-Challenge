...
import br.com.fiap.oficina.servico.presentation.dto.ItemOrcamentoDto
import br.com.fiap.oficina.servico.presentation.dto.OrcamentoDto
import br.com.fiap.oficina.servico.presentation.dto.PecaServicoDto
import br.com.fiap.oficina.servico.presentation.dto.ServicoDto
import br.com.fiap.oficina.servico.presentation.dto.TempoMedioExecucaoDto
import org.springframework.stereotype.Component

@Component
class ServicoMapper {
    fun toResponse(ordemServico: OrdemServico): ServicoDto = ServicoDto(
        ...
        ordemServico.funcionarioId.valor
            .toString(),
        clienteId =
        ordemServico.clienteId.valor
            .toString(),
        veiculoId =
        ordemServico.veiculoId.valor
            .toString(),
        pecas =
