...
@Component
class ClienteMapper {
    fun toResponse(cliente: Cliente): ClienteDto = ClienteDto(
        id = cliente.id.valor,
        nome = cliente.nome,
    ...
    fun toEntity(dto: ClienteDto): Cliente = Cliente.criar(
        nome = dto.nome,
    ...
    fun toEnderecoDto(endereco: Endereco): EnderecoDto = EnderecoDto(
    ...
    fun toContatoDto(contato: Contato): ContatoDto = ContatoDto(
        tipo = contato.tipo,
        nome = contato.nome,
        telefone = contato.telefone,
    )

    fun toEnderecoEntity(dto: EnderecoDto): Endereco = Endereco.criar(
    ...
    fun toContatoEntity(dto: ContatoDto): Contato = Contato.criar(
        tipo = dto.tipo,
        nome = dto.nome,
