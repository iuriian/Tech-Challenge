...
@Component
class VeiculoMapper {
    fun toResponse(veiculo: Veiculo): VeiculoDTO = VeiculoDTO(
        id = veiculo.id.valor,
        nome = veiculo.nome,
        marca = veiculo.marca,
    ...
    fun toEntity(dto: VeiculoDTO): Veiculo = Veiculo.criar(
        marca = dto.marca,
        nome = dto.nome,
        modelo = dto.modelo,
        ano = dto.ano,
    ...
    fun toEntityComId(id: String, dto: VeiculoDTO): Veiculo = Veiculo(
        id = Id.fromString(id),
        marca = dto.marca,
        nome = dto.nome,
        modelo = dto.modelo,
