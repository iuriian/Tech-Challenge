...
class SequenciaOrdemServicoRepositoryAdapterTest {
    @Mock
    ...
    private lateinit var repository: SequenciaOrdemServicoRepositoryAdapter

    @BeforeEach
    fun setup() {
        repository =
            SequenciaOrdemServicoRepositoryAdapter(
                entityManager,
            )
    }
