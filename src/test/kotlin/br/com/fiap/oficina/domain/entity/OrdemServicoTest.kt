...
class OrdemServicoTest {
    ...
    fun `deve criar ordem de servico valida com status padrao`() {
        ...
        assertTrue(ordemServico.orcamento.itens.isEmpty())
    }

    @Test
    fun `deve criar ordem de servico com status e orcamento informados`() {
        val item =
        ...
        assertEquals(orcamento, ordemServico.orcamento)
    }
    ...
    @Test
    fun `deve criar ordem de servico com orcamento vazio por padrao`() {
        val ordemServico =
            criarOrdemServico(
        ...
        assertEquals(
            BigDecimal.ZERO,
            ordemServico.orcamento.valorTotal,
        )
    }
}
